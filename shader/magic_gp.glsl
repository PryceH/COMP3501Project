...
void main(void){
    ...
    float p_size = particle_size*500; //
    ...
    v[0] = vec4(position.x - 0.5*p_size, position.y, position.z - 0.5*p_size, 1.0);
    v[1] = vec4(position.x + 0.5*p_size, position.y, position.z - 0.5*p_size, 1.0);
    v[2] = vec4(position.x - 0.5*p_size, position.y, position.z + 0.5*p_size, 1.0);
    v[3] = vec4(position.x + 0.5*p_size, position.y, position.z + 0.5*p_size, 1.0);
